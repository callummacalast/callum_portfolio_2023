...
<section class="bg-gray-800 text-gray-100 py-10">
    <div class="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8 tech-stack">
        <h2 class="text-3xl font-bold ">Preferred Technology</h2>
        <div class="flex flex-wrap justify-center lg:justify-between">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-12 h-12 mx-10 my-6 fill-current hover:fill-white md:mx-12 lg:m-0 text-gray-400 hover:scale-150 transition ease">
                <title>Laravel</title>
